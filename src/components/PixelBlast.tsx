...
// Typings for postprocessing may be missing; if errors occur, run: bun add -d @types/postprocessing
import { Effect, EffectComposer, EffectPass, RenderPass } from "postprocessing";
import type React from "react";
import { useEffect, useRef } from "react";
// Typings for three.js may be missing; if errors occur, run: bun add -d @types/three
